> [!IMPORTANT]
> Claude seems to have blocked all non-browser traffic to their API – Effectively rendering this project useless. **If you have a fix/method to get around this please PR**. Sorry – @Explosion-Scratch
